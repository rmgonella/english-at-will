...
<head>
    ...
    <title>Editar Postagem - English At Will</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <?php if($data['post']): ?>
                <form action="index.php?url=admin/editPost/<?php echo $data['post']->id; ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Título (PT)</label>
                            <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($data['post']->title); ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Título (EN)</label>
                            <input type="text" name="title_en" class="form-control" value="<?php echo htmlspecialchars($data['post']->title_en); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if ($data['post']->image_url): ?>
                            <div class="mb-2">
                                <img src="<?php echo $data['post']->image_url; ?>" alt="Atual" style="max-height: 100px;" class="img-thumbnail">
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="image_url" class="form-control" value="<?php echo htmlspecialchars($data['post']->image_url); ?>">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Conteúdo (PT)</label>
                        <textarea name="content" class="form-control" rows="10" required><?php echo htmlspecialchars($data['post']->content); ?></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Conteúdo (EN)</label>
                        <textarea name="content_en" class="form-control" rows="10" required><?php echo htmlspecialchars($data['post']->content_en); ?></textarea>
                    </div>
            ...
            <?php else: ?>
                <div class="alert alert-danger">Postagem não encontrada.</div>
            <?php endif; ?>
        </div>
    </div>
